...
class persona_model extends CI_model {
	...
	public function get_persona(){
		$this->db->select('p.DUI_persona, p.nombre1, p.nombre2, p.nombre3, p.nombre4, p.apellido1, p.apellido2, p.apellido3, p.telefono, p.direccion, p.fnacimiento, p.fexpedicion, p.fexpiracion, e.nombre_estadoh, s.nombre_sexo, m.nombre_municipio, d.nombre, p.foto, p.rutaimg');
	...
	public function set_persona($datos, $fa, $fe){
		...
		$this->db->set('foto', $datos['foto']);
		$this->db->set('rutaimg', $datos['ruta']);
	...
	public function act_persona($datos){
		$this->db->set('nombre1', $datos['nombre1']);
		$this->db->set('nombre2', $datos['nombre2']);
		if (empty($datos['nombre3'])){
			$this->db->set('nombre3', "NULL", FALSE);
		...
		$this->db->set('direccion', $datos['direccion']);
		$this->db->set('fnacimiento', $datos['fnacimiento']);
		$this->db->set('fexpedicion', $datos['fexpedicion']);
		$this->db->set('fexpiracion', $datos['fexpiracion']);
		$this->db->set('id_estadoh', $datos['estado']);
		$this->db->set('id_sexo', $datos['sexo']);
		$this->db->set('id_municipio', $datos['municipio']);
		$this->db->set('foto', $datos['foto']);
